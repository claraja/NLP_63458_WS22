...
class RDFSerialiser(RDFSerialiserInterface):
    ...
    def serialise_knowledgebase(self, output_path):
        ...
        self._graphmanager.get_serialized_graph(output_path, self._serialisation_format)
